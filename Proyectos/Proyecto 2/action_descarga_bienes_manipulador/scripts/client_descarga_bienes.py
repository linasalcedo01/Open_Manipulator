...
from action_descarga_bienes_manipulador.msg import descarga_bienesAction, descarga_bienesGoal
...
def main():
    ...
    rospy.init_node('client_descarga_bienes')

    # Crea un cliente de acción. Aquí 'recogida' es el nombre del servidor al que se quiere conectar.
    cliente = actionlib.SimpleActionClient('descarga_bienes', descarga_bienesAction)
